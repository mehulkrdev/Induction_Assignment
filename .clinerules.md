...
* Cargo.toml → `crates\agent_logger\Cargo.toml`
...
* Rust commands MUST run from:
  ...
  *`Cargo.toml` exists in c/Users/Mehul\ Kumar/Documents/IDrive_Codebase/Assignment/crates/agent/
...
```bash
wsl
cd /mnt/c/Users/Mehul\ Kumar/Documents/IDrive_Codebase/Assignment
